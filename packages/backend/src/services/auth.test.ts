  ...
  describe('User Registration', () => {
    it('should register a new user with password authentication', async () => {
      const program = E.gen(function* () {
        ...
        // Register user
        const result = yield* db.query('SELECT register_user($1, $2, $3) as user_data', [
          'test@example.com',
          'Test User',
          'SecurePassword123!',
        ]);
      ...
      const result = await E.runPromise(
        program.pipe(E.provide(RealDatabaseService.of(realDbService))),
      );
    ...
    it('should prevent duplicate email registration', async () => {
      const program = E.gen(function* () {
        ...
        // Register first user
        yield* db.query('SELECT register_user($1, $2, $3)', [
          'test@example.com',
          'Test User',
          'SecurePassword123!',
        ]);
    ...
    it('should create password credentials and verification token', async () => {
      const program = E.gen(function* () {
        ...
        // Register user
        const userResult = yield* db.query('SELECT register_user($1, $2, $3) as user_data', [
          'test@example.com',
          'Test User',
          'SecurePassword123!',
        ]);
  ...
  describe('Email Verification', () => {
    it('should verify email with valid token', async () => {
      const program = E.gen(function* () {
        ...
        // Verify email
        const verifyResult = yield* db.query('SELECT verify_email($1) as verified', [token]);
    ...
    it('should reject invalid verification token', async () => {
      const program = E.gen(function* () {
        ...
        const result = yield* db.query('SELECT verify_email($1) as verified', ['invalid-token']);
  ...
  describe('Password Login', () => {
    it('should login with correct credentials after email verification', async () => {
      const program = E.gen(function* () {
        ...
        // Now try to login
        const loginResult = yield* db.query('SELECT * FROM login_with_password($1, $2)', [
          'test@example.com',
          'SecurePassword123!',
        ]);
    ...
    it('should reject login before email verification', async () => {
      const program = E.gen(function* () {
        ...
        yield* db.query('SELECT * FROM login_with_password($1, $2)', [
          'test@example.com',
          'SecurePassword123!',
        ]);
      });
  ...
  describe('Authentication Method Switching', () => {
    it('should switch from password to webauthn authentication', async () => {
      const program = E.gen(function* () {
        ...
        // Switch to WebAuthn
        const switchResult = yield* db.query('SELECT switch_auth_method($1, $2) as user_data', [
          userId,
          'webauthn',
        ]);
    ...
    it('should switch from webauthn to password authentication', async () => {
      const program = E.gen(function* () {
        ...
        yield* db.query('SELECT switch_auth_method($1, $2)', [userId, 'webauthn']);
  ...
  describe('Session Management', () => {
    it('should create and retrieve user session', async () => {
      const program = E.gen(function* () {
        ...
        const sessionResult = yield* db.query('SELECT current_user_from_session($1) as user_data', [
          sessionToken,
        ]);
    ...
    it('should logout and invalidate session', async () => {
      const program = E.gen(function* () {
        ...
        // Logout
        const logoutResult = yield* db.query('SELECT logout($1) as success', [sessionToken]);
