  ...
  return (
    <div className="space-y-12">
      <section className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Solid Octo Invention</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">
              PostGraphile for automatic GraphQL API generation, Graphile Worker for background
              jobs, and Graphile Migrate for database schema management.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">
              Modern React with hooks and concurrent features, Apollo Client for GraphQL data
              fetching with intelligent caching.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">
              Functional programming with Effect-TS for type-safe side effects, error handling, and
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">
              Clean architecture with domain-driven design principles, making impossible states
              impossible with TypeScript.
            </p>
          </div>
        </div>
      </section>
